...
<div class="w-full h-full bg-slate-50  flex justify-center items-center">

    <div class="bg-white shadow-2xl rounded-2xl  grid grid-cols-1 lg:flex py-16 px-4 mx-auto  lg:py-16 lg:px-6 ">
            <div class="w-full">
            ...
            <div class="mx-auto pt-4 max-w-screen-sm text-center">
                <h1 class="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-blue-600 ">404</h1>
                <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl ">Il manque quelque chose.
                </p>
                <p class="mb-4 text-lg font-light text-gray-500 ">Désolé, nous ne pouvons pas trouver cette page. Vous
                    trouverez beaucoup de choses à explorer sur la page d'accueil.</p>
                <a href="/home"
                    class="inline-flex text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4">Retour
