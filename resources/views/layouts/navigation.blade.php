<nav x-data="{ open: false }" class="bg-gray-700 h-16 sticky grid sm:block grid-cols-2 border-gray-100 z-50">
    ...
    <div class="flex sm:hidden  items-center justify-end pr-2  z-50">
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button
                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{ 'block': open, 'hidden': !open }"
        class="hidden bg-white w-full h-screen shadow-lg rounded sm:hidden overflow-y-auto">
        ...
        <div class="pt-4 pb-1 border-t  bg-white border-gray-200">
            <div
                ...
                <a class="flex text-laravel font-medium text items-center hover:bg-slate-300 ml-1  p-3 w-full {{ request()->is('rapports') ? 'border-l-4 border-indigo-400 text-gray-600 bg-slate-100' : '' }} {{ request()->is('rapports/*') ? 'border-l-4 border-indigo-400 text-gray-600 bg-slate-100' : '' }}"
                    href="/rapports">
                    <svg width="25px" height="25px" viewBox="0 0 48 48" data-name="Layer 1" id="Layer_1"
                        xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <style>
                                .cls-1,
                ...
                <a href="/entres/create"
                    class="flex text-laravel font-medium text items-center hover:bg-slate-300  p-3 w-full  {{ request()->is('entres/create') ? 'border-l-4 border-indigo-400 text-gray-600 bg-slate-100' : '' }}{{ request()->is('entres/create_bar') ? 'border-l-4 border-indigo-400 text-gray-600 bg-slate-100' : '' }}">
                    <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
