...
<body style="height: 100%; background-color: #f5f5f5 " class="overflow-hidden">
    ...
    <div class="flex h-full w-full ">
        ...
        <main id="item" class="calc w-full  sm:p-2 overflow-y-auto">
            {{ $slot }}
        </main>
    </div>
</body>
