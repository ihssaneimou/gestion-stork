...
<body style="height: 100%; background-color: #f5f5f5 " class="overflow-hidden">
    ...
    <div class="flex h-full w-full ">
        ...
        <div id="sidebar"
            class='hidden flex-col items-start justify-start w-72 left-0 h-calc overflow-auto sm:flex pb-6 bg-gray-300 overflow-x-hidden'>
            <a href="/marchandises"
                class="flex text-laravel font-medium text items-center hover:bg-slate-400 w-full  p-3 {{ request()->is('marchandises/*') ? 'border-l-4 border-indigo-400 text-gray-600 bg-slate-300' : '' }} {{ request()->is('marchandises') ? 'border-l-4 border-indigo-400 text-gray-600 bg-gray-300' : '' }}">
