...
<body style="height: 100%; background-color: #f5f5f5 " class="overflow-hidden">
    ...
    <div class="flex h-full w-full ">
        ...
        <div id="sidebar"
            ...
            <a href="/marchandises"
                class="flex text-laravel font-medium text items-center hover:bg-slate-300 w-full  p-3 {{ request()->is('marchandises/*') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }} {{ request()->is('marchandises') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }}">
            ...
            <a class="flex text-laravel font-medium text items-center hover:bg-slate-300  p-3 w-full {{ request()->is('categories/entre/*') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }} {{ request()->is('categories/sortie/*') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }} {{ request()->is('categories/*/documents/*') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }} {{ request()->is('categories/*/documents') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }} {{ request()->is('documents') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }}" href="/documents">
            ...
            {{-- <a class="flex text-laravel font-medium text items-center hover:border-l-4 border-slate-500 bg-slate-300  p-3 w-full"
                href="/categories">
            ...
            <a class="flex text-laravel font-medium text items-center hover:bg-slate-300  p-3 w-full {{ request()->is('rapports') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }} {{ request()->is('rapports/*') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }}" href="/rapports">
            ...
            class="flex text-laravel font-medium text items-center hover:bg-slate-300  p-3 w-full {{ request()->is('entres/create') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }}">
            <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    @if (auth()->user()->role=='S')
                ...
                <a href="/register" class="flex text-laravel font-medium text items-center hover:bg-slate-300  p-3 w-full {{ request()->is('register') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }}">
                ...
                <a href="/admin/list" class="flex text-laravel font-medium text items-center hover:bg-slate-300  p-3 w-full {{ request()->is('admin/*') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }}">
            ...
            <div class="h-px  w-full my-4 bg-gray-600">‎</div>
                <a href="/scanner" class="flex text-laravel font-medium text items-center hover:bg-slate-300  p-3 w-full {{ request()->is('scanner') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }} {{ request()->is('marchandise-info/*') ? 'border-l-4 border-slate-500 bg-slate-300' : '' }}">
<svg width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 9h6V3H3zm1-5h4v4H4zm1 1h2v2H5zm10 4h6V3h-6zm1-5h4v4h-4zm1 1h2v2h-2zM3 21h6v-6H3zm1-5h4v4H4zm1 1h2v2H5zm15 2h1v2h-2v-3h1zm0-3h1v1h-1zm0-1v1h-1v-1zm-10 2h1v4h-1v-4zm-4-7v2H4v-1H3v-1h3zm4-3h1v1h-1zm3-3v2h-1V3h2v1zm-3 0h1v1h-1zm10 8h1v2h-2v-1h1zm-1-2v1h-2v2h-2v-1h1v-2h3zm-7 4h-1v-1h-1v-1h2v2zm6 2h1v1h-1zm2-5v1h-1v-1zm-9 3v1h-1v-1zm6 5h1v2h-2v-2zm-3 0h1v1h-1v1h-2v-1h1v-1zm0-1v-1h2v1zm0-5h1v3h-1v1h-1v1h-1v-2h-1v-1h3v-1h-1v-1zm-9 0v1H4v-1zm12 4h-1v-1h1zm1-2h-2v-1h2zM8 10h1v1H8v1h1v2H8v-1H7v1H6v-2h1v-2zm3 0V8h3v3h-2v-1h1V9h-1v1zm0-4h1v1h-1zm-1 4h1v1h-1zm3-3V6h1v1z"/><path fill="none" d="M0 0h24v24H0z"/></svg>
            ...
            {{-- <a href="/sorties/create"
                class="flex text-laravel font-medium text items-center hover:border-l-4 border-slate-500 bg-slate-300  p-3 w-full">
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M23 18C23 18.75 22.79 19.46 22.42 20.06C22.21 20.42 21.94 20.74 21.63 21C20.93 21.63 20.01 22 19 22C17.78 22 16.69 21.45 15.97 20.59C15.95 20.56 15.92 20.54 15.9 20.51C15.78 20.37 15.67 20.22 15.58 20.06C15.21 19.46 15 18.75 15 18C15 16.74 15.58 15.61 16.5 14.88C17.19 14.33 18.06 14 19 14C20 14 20.9 14.36 21.6 14.97C21.72 15.06 21.83 15.17 21.93 15.28C22.59 16 23 16.95 23 18Z"
