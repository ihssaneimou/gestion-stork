            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class=" overflow-hidden gap-3 grid grid-cols-2 sm:grid-cols-3 justify-items-center">
                                      ...
                                      <div class="flex -m-4">
                                        ...
                                        <div class=" p-2 ml-10 w-full">
                                          <div class="border-2 border-gray-600  rounded-lg transform transition duration-500 hover:scale-110">
                                            <svg width="40px" height="40px" viewBox="0 0 24 24" class="text-indigo-500 w-12 h-12 inline-block" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                              <title/>
                                            ...
                                            <h6 class="title-font font-medium text-l text-gray-900">{{ $categorie->total_achetes }} </h6>
                                            <p class="leading-relaxed">Stock</S></p>
                                          </div>
                                        </div>
                                        <!-- Deuxième carreau -->
                                        <div class="p-2 mr-10 w-full">
                                          <div class="border-2 border-gray-600 rounded-lg transform transition duration-500 hover:scale-110">
                                            <svg width="40px" height="40px" viewBox="0 0 48 48" class="text-indigo-500 w-12 h-12 inline-block" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              <path fill-rule="evenodd" clip-rule="evenodd" d="M18.7071 4.69719C19.0976 4.30667 19.7308 4.30667 20.1213 4.69719L28.6066 13.1825C28.9971 13.573 28.9971 14.2062 28.6066 14.5967C28.216 14.9872 27.5829 14.9872 27.1924 14.5967L18.7071 6.1114C18.3166 5.72088 18.3166 5.08771 18.7071 4.69719Z" fill="#333333"/>
                                              <path fill-rule="evenodd" clip-rule="evenodd" d="M28.7071 4.7068C29.0976 5.09733 29.0976 5.73049 28.7071 6.12102L20.2218 14.6063C19.8313 14.9968 19.1981 14.9968 18.8076 14.6063C18.4171 14.2158 18.4171 13.5826 18.8076 13.1921L27.2929 4.7068C27.6834 4.31628 28.3166 4.31628 28.7071 4.7068Z" fill="#333333"/>
                                            ...
                                            <h6 class="title-font font-medium text-l text-gray-900">{{ $categorie->total_vendus }}</h6>
                                            <p class="leading-relaxed">Sorties</p>
                                          </div>
                                        </div>
                    ...
                    >
                     ...
                     <p class="text-center  text-2xl font-bold text-indigo-500 ">Autre</p>
                                 <br>
                                 <section class="text-gray-700 body-font">
                                    <div class="container mx-auto px-4 ">
                                      <div class="flex -m-4">
                                        ...
                                        <div class=" p-2 w-full">
                                          <div class="border-2 border-gray-600 mb-5 rounded-lg transform transition duration-500 hover:scale-110">
                                            <svg width="40px" height="40px" viewBox="0 0 24 24" class="text-indigo-500 w-12 h-12 mb-3 inline-block" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                              <title/>
                                              <g fill="none" fill-rule="evenodd" id="页面-1" stroke="none" stroke-width="1">
                                                <g id="导航图标" transform="translate(-325.000000, -80.000000)">
                                                  <g id="编组" transform="translate(325.000000, 80.000000)">
                                            ...
                                            <h6 class="title-font font-medium text-l text-gray-900">{{$entres}}</h6>
                                            <p class="leading-relaxed">Stock</S></p>
                                          </div>
                                        </div>
                                        <!-- Deuxième carreau -->
                                        <div class="p-2  w-full">
                                          <div class="border-2 border-gray-600 mb-5 rounded-lg transform transition duration-500 hover:scale-110">
                                            <svg width="40px" height="40px" viewBox="0 0 48 48" class="text-indigo-500 w-12 h-12 mb-3 inline-block" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              <path fill-rule="evenodd" clip-rule="evenodd" d="M18.7071 4.69719C19.0976 4.30667 19.7308 4.30667 20.1213 4.69719L28.6066 13.1825C28.9971 13.573 28.9971 14.2062 28.6066 14.5967C28.216 14.9872 27.5829 14.9872 27.1924 14.5967L18.7071 6.1114C18.3166 5.72088 18.3166 5.08771 18.7071 4.69719Z" fill="#333333"/>
                                              <path fill-rule="evenodd" clip-rule="evenodd" d="M28.7071 4.7068C29.0976 5.09733 29.0976 5.73049 28.7071 6.12102L20.2218 14.6063C19.8313 14.9968 19.1981 14.9968 18.8076 14.6063C18.4171 14.2158 18.4171 13.5826 18.8076 13.1921L27.2929 4.7068C27.6834 4.31628 28.3166 4.31628 28.7071 4.7068Z" fill="#333333"/>
                                              <path fill-rule="evenodd" clip-rule="evenodd" d="M24.3162 15.0513C24.111 14.9829 23.8891 14.9829 23.6838 15.0513L8.86851 19.9889C8.64603 20.063 8.463 20.2102 8.34247 20.3985L4.39805 25.4613C4.1985 25.7175 4.13573 26.0545 4.2297 26.3653C4.32367 26.6761 4.56269 26.922 4.87072 27.0246L8.19325 28.1319L8.19595 36.7634C8.19636 38.0544 9.02257 39.2003 10.2473 39.6085L23.6291 44.0691C23.7475 44.1164 23.8738 44.1406 24.0009 44.1405C24.1293 44.141 24.2569 44.1168 24.3765 44.069L37.7577 39.6086C38.9827 39.2003 39.8089 38.054 39.809 36.7628L39.8096 28.1328L43.1346 27.0246C43.4427 26.922 43.6817 26.6761 43.7757 26.3653C43.8696 26.0545 43.8069 25.7175 43.6073 25.4613L39.6117 20.3327C39.4927 20.176 39.3274 20.0542 39.1315 19.9889L24.3162 15.0513ZM9.54341 22.1112L22.346 26.378L19.6478 29.8413L6.8452 25.5745L9.54341 22.1112ZM24.0025 24.8203L35.6526 20.9376L24 17.0541L12.35 20.9367L24.0025 24.8203ZM10.196 36.7628L10.1935 28.7986L19.686 31.9622C20.088 32.0962 20.5307 31.9623 20.7911 31.6281L23.0003 28.7924L23.0001 41.7513L10.8797 37.7112C10.4715 37.5751 10.1961 37.1931 10.196 36.7628ZM37.8095 28.7993L28.3193 31.9622C27.9174 32.0962 27.4747 31.9623 27.2143 31.6281L25.0013 28.7876L25.0049 41.7514L37.1252 37.7113C37.5336 37.5752 37.809 37.1931 37.809 36.7627L37.8095 28.7993ZM28.3576 29.8413L25.6583 26.3767L38.4609 22.1099L41.1602 25.5745L28.3576 29.8413Z" fill="#333333"/>
                                            </svg>
                                            <h6 class="title-font font-medium text-l text-gray-900">{{$sorties}}</h6>
                                            <p class="leading-relaxed">Sorties</p>
                                          </div>
                                        </div>
                                        <!-- Ajouter d'autres carreaux si nécessaire -->
