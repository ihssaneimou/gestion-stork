    ...
    <body>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function initializeChart3(ctx, type, labels, datasets) {
                    return new Chart(ctx, {
                        type: type,
                        innerRadius: 90,
                        data: {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.chartDataentre.length > 0 || data.chartDatasortie.length > 0) {
                            var labels = data.chartDataentre.map(function(item) {
                                return item.date;
                            });
                            var quantitiesEntre = data.chartDataentre.map(function(item) {
                                return item.quantite;
                            });
                            var quantitiesSortie = data.chartDatasortie.map(function(item) {
                                return item.quantite;
                            });
